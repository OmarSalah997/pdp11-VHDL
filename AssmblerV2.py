...
#    line=line.rstrip()
#    
#    if('HLT' in line or 'hlt' in line):
#        break
#    if('#' in line or 'define' in line):
...
#        continue
    ...
    if(operands.find(',')!=-1): #this means 2 operand instruction,need to separate the operands
        ...
        if('#' in operand1 or operand1.isnumeric()):
           count+=1
        else:
            tstforidxsrc=''
            i=0
            ...
            if(tstforidxsrc.isdigit()):
                count+=1
        if('#' in operand2 or operand2.isnumeric()):
           count+=1
        else:
            tstforidxdist=''
            i=0
            ...
            if('#' in operands or operands.isnumeric()):
               if(instruction in Branch ==False):
                   count+=1
            else:
                tstforidxdist=''
                i=0
